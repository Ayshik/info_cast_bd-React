...
const Admin_AC=()=>{
  ...
  useEffect(()=>{
      axios.get("http://localhost:8000/api/All_connection")
      .then(resp=>{
  ...
  const Changestatus = (e,id) => {
    e.preventDefault();
      ...
      axios.put(`/api/Update-status-payment/${id}`)
              ...
              <div className="card my-4">
                <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 className="text-white text-capitalize ps-3">Active Customer table</h6>
                  </div>
                </div>
                    ...
                    <table className="table align-items-center mb-0">
                      <thead>
                        ...
                        <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Id</th>
                          ...
                          <th className="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Payment Status</th>
                          <th className="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Connection Status</th>
                ...
                products.map(p=>(
                        <tr key={p.id}>
                          ...
                          <td className="align-middle text-center text-sm">
                            <span className="badge badge-sm bg-gradient-warning">{p.lstatus}</span>
                          </td>
